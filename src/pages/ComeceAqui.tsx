                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <Link to="/protocolos/escudo-72h" className="p-4 bg-secondary rounded border border-border hover:border-primary transition-colors group flex items-center gap-3">
                        <ShieldIcon size="sm" />
                        <div>
